...
import { Menu, User, Compass, Brain, Activity, Target, Zap, Clock, TrendingUp, AlertCircle, CheckCircle2, Briefcase, Sparkles } from "lucide-react";
...
const JourneyPage = () => {
  ...
  // Need to import Briefcase specifically if used, but we'll stick to Target for now
      ...
      <header className="sticky top-0 z-40 flex items-center justify-between px-3 md:px-6 py-2.5 md:py-3 bg-[#F8F9FA]/80 backdrop-blur-xl border-b border-gray-100/50 w-full">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[17px] font-semibold text-[#444746] tracking-tight">Career Journey</span>
          </div>
        </div>
        ...
        <div className="max-w-[1128px] mx-auto pt-6 px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {/* Memory Vault (What Aarika Knows) */}
              <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                <h2 className="text-lg font-bold text-gray-800 flex items-center gap-2 mb-4">
