...
const ProfilePage = () => {
  ...
  return (
    <div className={`min-h-screen w-[100%] text-white overflow-y-auto`}>
      {/* Header */}
      <div className={`bg-gray-800 border-gray-700 shadow-sm border-b`}>
      ...
      {/* Navigation Tabs */}
      <div className={`bg-gray-800 border-gray-700 border-b sticky top-0 z-10`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className={` border-gray-700 rounded-lg sm:rounded-xl shadow-sm border`}>
