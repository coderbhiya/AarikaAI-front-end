    ...
    <div className={`min-h-screen overflow-y-auto`}>
      <div className="container mx-auto px-4 py-8">
          ...
          <form onSubmit={applyFilters} className="space-y-4 md:space-y-0 md:grid md:grid-cols-4 md:gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border border-gray-600 bg-gray-700 text-white rounded-md focus:ring-2 focus:ring-blue-500`}
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-2 border border-gray-600 bg-gray-700 text-white rounded-md focus:ring-2 focus:ring-blue-500`}
              >
                <option value="" className={`bg-gray-700 text-white`}>All Locations</option>
                {availableFilters.locations.map((location, index) => (
                  <option key={index} value={location} className={`bg-gray-700 text-white}`}>{location}</option>
                ))}
              </select>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-2 border border-gray-600 bg-gray-700 text-white rounded-md focus:ring-2 focus:ring-blue-500`}
              >
                <option value="" className={`bg-gray-700 text-white`}>All Types</option>
                {availableFilters.employmentTypes.map((type, index) => (
                  <option key={index} value={type} className={`bg-gray-700 text-white`}>{type}</option>
                ))}
              </select>
            </div>
        ...
        {loading ? (
          ...
          <div className={`bg-red-900 border-red-700 text-red-200 border px-4 py-3 rounded-md mb-4`}>
            {error}
          </div>
        ) : jobs.length === 0 ? (
