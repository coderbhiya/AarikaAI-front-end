...
const NewChatButton = ({ onClick }: { onClick?: () => void }) => {
  return (
    <button
      className="flex items-center justify-between w-full gap-2 rounded-md bg-white/5 border border-white/10 py-3 px-4 hover:bg-white/10 transition-colors"
      onClick={onClick}
    >
  ...
  return (
    <div className="relative">
      ...
      <input
        type="text"
        placeholder="Search"
        className="w-full bg-white/5 border border-white/10 rounded-md py-2 pl-10 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-white/20"
      />
    </div>
  );
};
      ...
      >
        ...
        <div className="flex flex-col gap-2 p-4">
          <SidebarItem
            ...
            label="AI Chat Tool Ethics"
          />
          <SidebarItem
            icon={<MessageSquare size={18} />}
            label="AI Chat Tool Impact Writing"
          />
          ...
          <SidebarItem
            icon={<MessageSquare size={18} />}
            label="How can I increase..."
            hasMoreOptions={true}
          />
          <SidebarItem
            icon={<MessageSquare size={18} />}
            label="What's the best app..."
            hasMoreOptions={true}
          />
          <SidebarItem
            icon={<MessageSquare size={18} />}
            label="What's the best appro..."
            hasMoreOptions={true}
          />
        </div>
